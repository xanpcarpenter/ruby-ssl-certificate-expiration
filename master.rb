...
File.open('expiration_report.txt', 'w') {|file| file.write("This is an automated report.  It was generated on #{time} \r\n \r\nPlease contact the Xantrion NOC <support@xantrion.com> if you have any questions.\r\n\r\nThe following SSL Certs are expired or are due to expire in the next 30 days:\r\n\r\n") }

# open the text file and pass each name to the cert check method
text=File.read("sites.txt").chomp#.split("\n")
